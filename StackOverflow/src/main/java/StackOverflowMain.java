...
public class StackOverflowMain {
    public static void main(String[] args) {
        ...
        // Register users
        User user1 = new User(1, "Prasuk", "password123", "prasuk@example.com", 0);
        User user2 = new User(2, "Nimish", "password456", "nimish@example.com", 0);
        stackOverflow.registerUser(user1);
        stackOverflow.registerUser(user2);

        // User login
        User loggedInUser = stackOverflow.loginUser("Prasuk", "password123");
